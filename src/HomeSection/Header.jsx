          ...
          >
            <ul className="flex flex-col md:flex-row md:items-center mt-2 md:mt-0 space-y-2 md:space-y-0 md:space-x-8 text-base font-medium">
              ...
              <li className="md:ml-8 mt-2 md:mt-0">
                <Link
                  to="/cart"
                  className="relative flex items-center px-3 py-2 rounded-md text-slate-700 dark:text-slate-100 hover:bg-yellow-50 hover:text-yellow-800 dark:hover:bg-yellow-900 dark:hover:text-yellow-200 transition-colors focus:outline-none focus:ring-2 focus:ring-yellow-400"
